                        ...
                        <div class="col-md-8 company__base-info">
                            ...
                            <div class="bill">
                                <button class="collapsed main-collapse" data-toggle="collapse">
                                    Информация об уплате налогов и других обязательных платежей<i><img
                                        src="data:image/svg+xml;base64,"
                                        alt=""></i>
                                </button>
                                <div id="ceo" class="collapse">
                            ...
                            <div class="company__markers">
                                ...
                                <div v-else>
                                   ...
                                   <!--  <table class="table table-striped">
                                      <thead>
                                        <tr >
                                          <th style=" text-align: center;" scope="col">Вид налога</th>
                                          <th scope="col">2013г</th>
                                          <th scope="col">2014г</th>
                                          <th scope="col">2015г</th>
                                          <th scope="col">2016г</th>
                                          <th scope="col">2017г</th>
                                          <th style=" text-align: center;" scope="col"><h6>В 2018 году по состоянию на первое число периода</h6></th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        <tr>
                                          <td style=" text-align: center;">Налоговые поступления</td>
                                          <td>3842,1</td>
                                          <td>1298,7</td>
                                          <td>1765,3</td>
                                          <td>1976,8</td>
                                          <td>2567,2</td>
                                          <td style=" text-align: center;">879,4</td>
                                        </tr>
